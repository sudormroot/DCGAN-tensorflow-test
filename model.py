      ...
      for idx in xrange(0, int(batch_idxs)):
        ...
        if config.dataset == 'mnist':
          ...
          if counter == 10: 
            ...
            profile_result="timeline.mnist.gpu.D-network-update.step-%d.umem-%s.batchsize-%d.json"%(counter, UNIFIED_MEMORY_SET, self.batch_size)
            ...
            profile_result="timeline.mnist.gpu.G-network-update.step-%d.umem-%s.batchsize-%d.json"%(counter, UNIFIED_MEMORY_SET, self.batch_size)
          ...
          if counter == 10:
            ...
            profile_result="timeline.celeba.gpu.D-network-update.step-%d.umem-%s.batchsize-%d.json"%(counter, UNIFIED_MEMORY_SET, self.batch_size)
            ...
            profile_result="timeline.gpu.G-network-update.step-%d.umem-%s.batchsize-%d.json"%(counter, UNIFIED_MEMORY_SET, self.batch_size)
